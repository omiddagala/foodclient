(function () {
    ...
    function restaurantCtrl($scope, $compile, $uibModal, baProgressModal, $http, localStorageService, $parse, $rootScope, toastrConfig, toastr, $location) {
        ...
        $scope.loadContent = function (isFirstCall, isSearch) {
            ...
            $http.post("http://127.0.0.1/v1/employee/findRestaurantByName", params, httpOptions)
        ...
        $scope.addComments = function () {
            ...
            $http.post("http://127.0.0.1/v1/restaurantComment/add", params, httpOptions)
                .success(function (data, status, headers, config) {
        ...
        $scope.fetchComments = function () {
            ...
            $http.post("http://127.0.0.1/v1/restaurantComment/getFoodComments", params, httpOptions)
                .success(function (data, status, headers, config) {
                    if (data.length > 0) {
        ...
        $scope.rateRestaurant = function (rate) {
            ...
            $http.post("http://127.0.0.1/v1/employee/rateRestaurant", params, httpOptions)
                .success(function (data, status, headers, config) {
                    showMessage(toastrConfig, toastr, "پیام", "عملیات با موفقیت انجام شد", "success");
                    stopLoading();
                }).catch(function (err) {
