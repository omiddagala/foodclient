    ...
    function ProfilePageCtrl($scope, fileReader, $filter, $http, localStorageService, $state, $rootScope, toastrConfig, toastr) {
        ...
        $scope.initCtrl = function () {
            ...
            setTimeout(function () {
                ...
                $http.post("http://127.0.0.1/v1/employee/getProfileData", null, httpOptions)
        ...
        $scope.removePicture = function () {
            ...
            $http.post("http://127.0.0.1/v1/employee/removeProfileImage", null, httpOptions)
                .success(function (data, status, headers, config) {
                    stopLoading();
        ...
        function uploadPic(img, postfix) {
            ...
            $http.post("http://127.0.0.1/v1/employee/uploadProfileImage", params, httpOptions)
                .success(function (data, status, headers, config) {
        ...
        $scope.saveOrUpdate = function (form) {
            ...
            $http.post("http://127.0.0.1/v1/employee/edit", $scope.employee, httpOptions)
                .success(function (data, status, headers, config) {
                    stopLoading();
                    showMessage(toastrConfig, toastr, "پیام", "عملیات با موفقیت انجام شد", "success");
                    $scope.submitted = false;
