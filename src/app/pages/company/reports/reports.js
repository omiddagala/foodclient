(function () {
    ...
    function coReports($scope, $filter, editableOptions, editableThemes, $state, $rootScope,$q, $http, localStorageService, $location, $uibModal, $timeout, toastrConfig, toastr) {
        ...
        $scope.search = function (pagination, sort) {
            ...
            return $http.post("https://demoapi.karafeed.com/pepper/v1/company/getSellerRestaurantList", param, httpOptions)
        ...
        $scope.factorsOfKarafeed = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/company/getInvoiceOfKarafeed", params, httpOptions)
        ...
        $scope.restaurantFactor = function(id,name){
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/company/getInvoiceOfRestaurant", params, httpOptions)
                .success(function (data, status, headers, config) {
