(function () {
    ...
    function companyActiveUsersCtrl($scope, $filter, editableOptions, editableThemes, $state, $q, $http, localStorageService, $location, $uibModal, $uibModalStack, toastrConfig, toastr, $rootScope) {
        ...
        $scope.edit = function () {
            ...
            $http.post("http://127.0.0.1/v1/companyEmployeeManagement/getEmployeeById", $rootScope.companyUserId, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.saveOrUpdateUser = function (form) {
            ...
            $http.post("http://127.0.0.1/v1/companyEmployeeManagement/addOrUpdateEmployee", $rootScope.userInfo, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $rootScope.userInfo = data.data;
        ...
        $scope.changePass = function (form) {
            ...
            $http.post("http://127.0.0.1/v1/companyEmployeeManagement/resetEmployeePassword", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.deactiveUser = function () {
            ...
            $http.post("http://127.0.0.1/v1/companyEmployeeManagement/deActiveEmployee", {id:$rootScope.companyUserId}, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $scope.showList();
                    $uibModalStack.dismissAll();
        ...
        $scope.doCharge = function (form) {
            ...
            $http.post("http://127.0.0.1/v1/company/chargeEmployee", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
        ...
        $scope.doGift = function (form) {
            ...
            $http.post("http://127.0.0.1/v1/company/giveGift", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    $scope.loadBalanceByRole();
        ...
        $scope.showDetail = function (item, index) {
            ...
            $http.post("http://127.0.0.1/v1/companyEmployeeManagement/getEmployeeExtraData", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $scope.employee = {
                        id: item.id,
