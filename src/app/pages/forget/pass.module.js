(function () {
    ...
    function forgetCtrl($scope, $uibModal, baProgressModal, $http, localStorageService, $rootScope, $location, toastrConfig, toastr,$state) {
        ...
        $scope.level1 = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/userSecurity/getResetCode", params, httpOptions)
        ...
        $scope.level2 = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/userSecurity/resetPassByCode", params, httpOptions)
                .success(function (data, status, headers, config) {
                    $scope.mylevel = '1';
