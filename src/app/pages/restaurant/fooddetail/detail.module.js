    ...
    function detailCtrl($scope, $filter, editableOptions, editableThemes, $location, $state, $http, $rootScope, localStorageService, toastrConfig, toastr) {
        $scope.initCtrl = function () {
            ...
            if ($scope.foodid) {
                ...
                return $http.post("http://127.0.0.1/v1/restaurant/food/getFoodById", $scope.foodid, httpOptions)
        ...
        $scope.saveOrUpdateFood = function (form) {
            ...
            return $http.post("http://127.0.0.1/v1/restaurant/food/addFood", $scope.food, httpOptions)
                .then(function (data, status, headers, config) {
                    if (!$scope.foodid)
                        $scope.food = data.data;
        ...
        $scope.saveOrUpdateAvailableDate = function (index, dayId) {
            ...
            return $http.post("http://127.0.0.1/v1/restaurant/food/addFoodAvailableDate", param, httpOptions)
                .then(function (data, status, headers, config) {
        ...
        $scope.removeDay = function (index, dayId) {
            ...
            return $http.post("http://127.0.0.1/v1/restaurant/food/deleteFoodAvailableDate", dayId, httpOptions)
                .then(function (data, status, headers, config) {
