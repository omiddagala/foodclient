(function () {
    ...
    function restReports($scope, $filter, editableOptions, editableThemes, $state, $q, $http, $rootScope,localStorageService, $location, $uibModal, $timeout, toastrConfig, toastr) {
        ...
        $scope.search = function (pagination, sort) {
            ...
            return $http.post("https://demoapi.karafeed.com/pepper/v1/restaurant/getBuyerCompanies", param, httpOptions)
        ...
        $scope.commissionsOfKarafeed = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/restaurant/getCommissionInvoice", params, httpOptions)
        ...
        $scope.factorsForKarafeed = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/restaurant/createInvoiceForKarafeed", params, httpOptions)
                .success(function (data, status, headers, config) {
        ...
        $scope.companyFactor = function(id,name){
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/restaurant/getInvoiceOfRestaurant", params, httpOptions)
                .success(function (data, status, headers, config) {
