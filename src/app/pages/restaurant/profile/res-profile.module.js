    ...
    function restaurantProfileCtrl($scope, fileReader, $filter, $uibModal, $http, localStorageService, $state,$rootScope, toastrConfig, toastr) {
        ...
        $scope.initCtrl = function () {
            ...
            setTimeout(function () {
                ...
                $http.post("https://demoapi.karafeed.com/v1/restaurant/getLoginRestaurantDetail", null, httpOptions)
        ...
        $scope.removePicture = function () {
            ...
            $http.post("https://demoapi.karafeed.com/v1/restaurant/removeProfileImage", null, httpOptions)
        ...
        function uploadPic(img, postfix) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/restaurant/uploadProfileImage", params, httpOptions)
                .success(function (data, status, headers, config) {
                    $scope.restInfo.imageAddress = data;
                    $rootScope.myProfilePic = data;
                    stopLoading();
