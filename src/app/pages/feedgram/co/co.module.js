...
(function () {
    ...
    function feedgramCoCtrl($scope, $compile, $uibModal, baProgressModal, $http, localStorageService, $parse, $rootScope, $state) {
        ...
        $scope.getAllEmployees = function (s) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/feedgram/employee/getCompanyEmployeeList", params, httpOptions)
        ...
        $scope.follow = function (id) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/feedgram/employee/followPage", params, httpOptions)
                .success(function (data, status, headers, config) {
                    stopLoading();
                }).catch(function (err) {
        ...
        $scope.getFollowers = function (s) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/feedgram/employee/getFollowerList", params, httpOptions)
                .success(function (data, status, headers, config) {
        ...
        $scope.getFollowings = function (s) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/feedgram/employee/getFollowingList", params, httpOptions)
                .success(function (data, status, headers, config) {
                    for (var i = 0; i < data.length; i++) {
