(function () {
    ...
    function adminCompanyUsersCtrl($scope, $filter, editableOptions, editableThemes, $state, $rootScope,$q, $http, localStorageService, $location, $uibModal, $uibModalStack, toastrConfig, toastr) {
        ...
        $scope.search = function (pagination, sort, search) {
            ...
            return $http.post("https://demoapi.karafeed.com/pepper/v1/adminEmployeeManagementRest/search", param, httpOptions)
        ...
        $scope.doCharge = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminEmployeeManagementRest/chargeEmployee", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.changePass = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminEmployeeManagementRest/resetEmployeePassword", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                }).catch(function (err) {
        ...
        $scope.sendMessage = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminEmployeeManagementRest/sendSMS", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
        ...
        $scope.sendSystemMessage = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminEmployeeManagementRest/sendSystemMessageToAll", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
