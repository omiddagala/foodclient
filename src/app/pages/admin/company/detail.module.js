(function () {
    ...
    function companyDetailCtrl($scope, fileReader, $filter, $uibModal, $http,$rootScope, localStorageService, $location,$state, toastrConfig, toastr) {
        ...
        $scope.initCtrl = function () {
            ...
            setTimeout(function () {
                ...
                if (id) {
                    ...
                    $http.post("http://127.0.0.1/v1/adminCompanyManagementRest/findById", id, httpOptions)
        ...
        $scope.saveOrUpdate = function (form) {
            ...
            $http.post("http://127.0.0.1/v1/adminCompanyManagementRest/addOrUpdateCompany", $scope.restInfo, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $scope.restInfo = data.data;
        ...
        $scope.searchRestaurants = function (s) {
            ...
            delayTimer = setTimeout(function () {
                ...
                $http.post("http://127.0.0.1/v1/adminRestaurantManagementRest/findByName",
                    param,
                    httpOptions)
        ...
        $scope.removePicture = function () {
            ...
            $http.post("http://127.0.0.1/v1/adminCompanyManagementRest/removeProfileImage", $scope.restInfo.id, httpOptions)
                .success(function (data, status, headers, config) {
                    stopLoading();
        ...
        function uploadPic(img, postfix) {
            ...
            $http.post("http://127.0.0.1/v1/adminCompanyManagementRest/uploadProfileImage", params, httpOptions)
                .success(function (data, status, headers, config) {
                    $scope.restInfo.imageAddress = data;
                    stopLoading();
                }).catch(function (err) {
