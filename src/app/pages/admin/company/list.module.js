(function () {
    ...
    function companyListCtrl($scope, $filter, editableOptions, editableThemes, $state, $rootScope,$q, $http, localStorageService, $location,$uibModal, $uibModalStack, toastrConfig, toastr) {
        ...
        $scope.search = function (pagination, sort,search) {
            ...
            return $http.post("https://demoapi.karafeed.com/v1/adminCompanyManagementRest/findByName", param, httpOptions)
        ...
        $scope.removeCompany = function () {
            ...
            return $http.post("https://demoapi.karafeed.com/v1/adminCompanyManagementRest/delete", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
        ...
        $scope.doCharge = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminCompanyManagementRest/chargeCompany", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
        ...
        $scope.sendMessage = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminCompanyManagementRest/sendSMS", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
        ...
        $scope.sendSystemMessage = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminCompanyManagementRest/sendSystemMessageToAll", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
        ...
        $scope.deactiveUser = function () {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminCompanyManagementRest/deActive", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.activateUser = function () {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminCompanyManagementRest/active", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.changePass = function () {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminCompanyManagementRest/resetCompanyPassword", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
