(function () {
    ...
    function adReports($scope, $filter, editableOptions, editableThemes, $state, $rootScope,$q, $http, localStorageService, $location, $uibModal, $timeout, toastrConfig, toastr) {
        ...
        $scope.search = function (pagination, sort) {
            ...
            if ($scope.customer === "R"){
                url = "https://demoapi.karafeed.com/pepper/v1/adminRestaurantManagementRest/findByName"
            } else {
                url = "https://demoapi.karafeed.com/pepper/v1/financial/getForceVateCompanyList";
            }
        ...
        $scope.karafeedCommissions = function (id,name) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/financial/createKarafeedCommissionInvoice", params, httpOptions)
        ...
        $scope.soldToKarafeed = function (id,name) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/financial/getRestaurantInvoiceForKarafeed", params, httpOptions)
                .success(function (data, status, headers, config) {
                    mydownload(data,name + '.pdf','application/pdf');
                    stopLoading();
                }).catch(function (err) {
        ...
        $scope.companyBuysOfKarafeed = function (id,name) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/financial/getInvoiceOfKarafeedForCompany", params, httpOptions)
                .success(function (data, status, headers, config) {
                    mydownload(data,name + '.pdf','application/pdf');
                    stopLoading();
                }).catch(function (err) {
