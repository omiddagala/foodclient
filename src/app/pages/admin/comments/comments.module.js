    ...
    function commentsCtrl($scope, $filter, editableOptions, editableThemes,$rootScope, $state, $q, $http, localStorageService, $location, $uibModal, $uibModalStack, toastrConfig, toastr) {
        ...
        $scope.search = function (pagination, sort) {
            ...
            if ($scope.commentType === "F"){
                url = "http://127.0.0.1/v1/adminCommentManagementRest/getNewComments";
            } else {
                url = "http://127.0.0.1/v1/adminCommentManagementRest/getNewCommentsOfRestaurant";
            }
        ...
        $scope.approve = function () {
            ...
            var url;
            if ($scope.commentType === "F"){
                url = "http://127.0.0.1/v1/adminCommentManagementRest/approve";
            } else {
                url = "http://127.0.0.1/v1/adminCommentManagementRest/approveRestaurantComment";
            }
        ...
        $scope.rejectC = function () {
            ...
            var url;
            if ($scope.commentType === "F"){
                url = "http://127.0.0.1/v1/adminCommentManagementRest/reject";
            } else {
                url = "http://127.0.0.1/v1/adminCommentManagementRest/rejectRestaurantComment";
            }
            $http.post(url, $scope.commentId, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
