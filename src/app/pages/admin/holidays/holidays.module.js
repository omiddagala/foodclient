    ...
    function holidaysCtrl($scope, $filter, editableOptions, editableThemes,$rootScope, $state, $q, $http, localStorageService, $location, $uibModal, $uibModalStack, toastrConfig, toastr) {
        ...
        $scope.search = function (pagination, sort) {
            ...
            if ($scope.holidayType === 'ramadan'){
                url = "https://demoapi.karafeed.com/pepper/v1/vacation/getRamadan";
            } else if ($scope.holidayType === 'vacation'){
                url = "https://demoapi.karafeed.com/pepper/v1/vacation/getVacationList";
            } else {
                url = "https://demoapi.karafeed.com/pepper/v1/vacation/getOffDaysList";
            }
        ...
        $scope.doAddRamadanHoliday = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/vacation/addRamadan", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.doAddVacationHoliday = function () {
            ...
            if ($scope.holidayType === 'vacation'){
                url = "https://demoapi.karafeed.com/pepper/v1/vacation/addVacation";
            } else {
                url = "https://demoapi.karafeed.com/pepper/v1/vacation/addKarafeedOffDay";
            }
        ...
        $scope.deleteHoliday = function () {
            ...
            var url;
            if ($scope.holidayType === 'vacation'){
                url = "https://demoapi.karafeed.com/pepper/v1/vacation/deleteVacation";
            } else {
                url = "https://demoapi.karafeed.com/pepper/v1/vacation/deleteOffDays";
            }
            $http.post(url, param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
