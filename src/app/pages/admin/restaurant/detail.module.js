(function () {
    ...
    function restaurantDetailCtrl($scope, fileReader, $filter, $uibModal, $http, $rootScope, localStorageService, $location, $state, toastrConfig, toastr) {
        ...
        $scope.initCtrl = function () {
            ...
            setTimeout(function () {
                ...
                if (id) {
                    ...
                    $http.post("http://127.0.0.1/v1/adminRestaurantManagementRest/findById", id, httpOptions)
        ...
        $scope.saveOrUpdate = function (form) {
            ...
            $http.post("http://127.0.0.1/v1/adminRestaurantManagementRest/addOrUpdate", $scope.restInfo, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $scope.restInfo = data.data.restaurant;
        ...
        $scope.removePicture = function () {
            ...
            $http.post("http://127.0.0.1/v1/adminRestaurantManagementRest/removeProfileImage", $scope.restInfo.id, httpOptions)
        ...
        function uploadPic(img, postfix) {
            ...
            $http.post("http://127.0.0.1/v1/adminRestaurantManagementRest/uploadProfileImage", params, httpOptions)
                .success(function (data, status, headers, config) {
                    $scope.restInfo.imageAddress = data;
                    stopLoading();
                }).catch(function (err) {
