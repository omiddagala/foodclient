(function () {
    ...
    function restListCtrl($scope, $filter, editableOptions, editableThemes, $state, $q, $http, $rootScope,localStorageService, $location,$uibModal, $uibModalStack, toastrConfig, toastr) {
        ...
        $scope.sendMessage = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminRestaurantManagementRest/sendSMS", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.sendSystemMessage = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminRestaurantManagementRest/sendSystemMessageToAll", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
        ...
        $scope.deactiveUser = function () {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminRestaurantManagementRest/deActiveRestaurant", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.activateUser = function () {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminRestaurantManagementRest/activeRestaurant", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.changePass = function () {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminRestaurantManagementRest/resetRestaurantPassword", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
        ...
        $scope.removeRest = function () {
            ...
            return $http.post("https://demoapi.karafeed.com/v1/adminRestaurantManagementRest/delete", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
        ...
        $scope.submitUploadedPaymentFile = function () {
            ...
            reader.onload = function(e) {
                ...
                $http.post("https://demoapi.karafeed.com/v1/financial/setPaidCheques", param, httpOptions)
        ...
        $scope.downloadPaymentFile = function(){
            ...
            $http.post("https://demoapi.karafeed.com/v1/financial/getRestaurantsChequeFile", null, httpOptions)
                .success(function (data, status, headers, config) {
        ...
        $scope.adminDatabaseOperation = function () {
            ...
            $http.post("https://demoapi.karafeed.com/v1/adminRestaurantManagementRest/updateDB", null, httpOptions)
                .success(function (data, status, headers, config) {
                    stopLoading();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
                }).catch(function (err) {
