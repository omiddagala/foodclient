(function () {
    ...
    function adminCharityCtrl($scope, $filter, editableOptions, editableThemes,$rootScope, $state, $q, $http, localStorageService, $location,$uibModal, $uibModalStack, toastrConfig, toastr) {
        ...
        $scope.search = function (pagination, sort,search) {
            ...
            return $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/findByName", param, httpOptions)
        ...
        $scope.removeCompany = function () {
            ...
            return $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/delete", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
        ...
        $scope.doCharge = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/chargeCompany", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
        ...
        $scope.sendMessage = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/sendSMS", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
        ...
        $scope.deactiveUser = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/deActive", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.activateUser = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/active", $scope.item.id, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
        ...
        $scope.changePass = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/resetCharityPassword", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $uibModalStack.dismissAll();
                    showMessage(toastrConfig,toastr,"پیام","عملیات با موفقیت انجام شد","success");
