(function () {
    ...
    function adminCharityDetailCtrl($scope, fileReader, $filter, $uibModal, $http, localStorageService, $location,$state, toastrConfig, toastr,$rootScope) {
        ...
        $scope.initCtrl = function () {
            ...
            setTimeout(function () {
                ...
                if (id) {
                    ...
                    $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/findById", id, httpOptions)
        ...
        $scope.saveOrUpdate = function (form) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/addOrUpdateCharity", param, httpOptions)
                .then(function (data, status, headers, config) {
                    stopLoading();
                    $scope.restInfo = data.data;
        ...
        $scope.removePicture = function () {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/removeProfileImage", $scope.restInfo.id, httpOptions)
        ...
        function uploadPic(img, postfix) {
            ...
            $http.post("https://demoapi.karafeed.com/pepper/v1/adminCharityManagementRest/uploadProfileImage", params, httpOptions)
                .success(function (data, status, headers, config) {
                    $scope.restInfo.imageAddress = data;
                    stopLoading();
                }).catch(function (err) {
